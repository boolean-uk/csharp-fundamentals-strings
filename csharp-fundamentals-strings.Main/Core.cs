...
namespace csharp_fundamentals_strings.Main
{
    public class Core
    {
        ...
        public string protocol => this.url.Substring(0, this.url.IndexOf(":"));


        //TODO: 5. Using the appropriate string method on url, set the value of the domain member below
        public int test
        {
            get { return this.url.IndexOf("k/");}
        }
        public string domain => this.url.Substring(this.url.IndexOf("//")+2, this.url.Length - test +1);


        //TODO: 6. Set the length member below to the length of the url member
        public int length => this.url.Length;
