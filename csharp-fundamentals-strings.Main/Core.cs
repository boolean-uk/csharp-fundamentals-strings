...
namespace csharp_fundamentals_strings.Main
{
    public class Core
    {
        ...
        //TODO: 2. There are currently some upper case characters in the URL. Using an appropriate string method on the fixedUrl member above, set the value of lowerCasedUrl.
        public string lowerCasedUrl => fixedUrl.ToLower();


        //TODO: 3. There is still white space on both ends of the URL! Use the appropriate string method to trim that white space and set the value of the url member below
        ...
        public string faqUrl => $"https://{domain}/faq";
