...
namespace csharp_fundamentals_strings.Main
{
    public class Core
    {
        ...
        public string fixedUrl => brokenUrl.Replace('z', 's'); // Note: This is extremely risky to do to most url-adresses, based on how the Replace function works 
        ...
        public string faqUrl => string.Concat(url.Substring(0,22),"faq");
    }
}
